...
def get_knn_results(client, userVectors):
    ...
    query = {
        ...
        "_source": False,
        "fields": ["content", "source", "page", "link"],
    }
    ...
    for i in response["hits"]["hits"]:
        ...
        source_link = "Source Link: " + str(i["fields"]["link"])
        new_line = "\n"

        similaritysearchResponse =  similaritysearchResponse + content + new_line + source + new_line + page_number + new_line + source_link + new_line + new_line
        count = count + 1
...
Based on the provided <context>, Answer the user's question in a concise manner, provide sources the source link and source page number to where the relevant information can be found. Include the source information at the end of your response
...
st.set_page_config(page_title="Post-Trade Compliance Q+A", page_icon=":tada", layout="wide")
